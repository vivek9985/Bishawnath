...
const PrimaryButton = ({ text = "Click here", type = "button", className = "" }) => {
    return (
        <button
            type={type}
            className={`flex items-center justify-center pl-5 pr-[52px] py-3.5 rounded-full bg-black dark:bg-primary outfit text-lg leading-[100%] relative overflow-hidden group ${className}`}>
            ...
            <div className="absolute -z-2 right-0.5 left-1.5 ml-auto mr-0 top-0 bottom-0 my-auto bg-white dark:bg-black w-10 h-10 group-hover:w-[calc(100%_-_4px)] duration-500 rounded-full flex items-center justify-end">
