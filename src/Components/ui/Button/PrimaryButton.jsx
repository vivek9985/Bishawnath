...
const PrimaryButton = ({ text = "Click here", type = "button", className = "" }) => {
    return (
        <button
            type={type}
            className={`flex items-center justify-center pl-5 pr-[52px] py-4 rounded-full bg-accent dark:bg-primary outfit text-lg leading-[100%] relative overflow-hidden group ${className}`}>
