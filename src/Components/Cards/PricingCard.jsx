...
const PricingCard = ({ type = "basic", price = 25, variant = "", className = "" }) => {
    ...
    return (
        <div className={`w-[300px] overflow-hidden relative rounded-3xl shadow-xl shadow-stone-100 dark:shadow-secondary ${className}`}>
            ...
            <div className="absolute z-0 left-0 top-0 w-full h-full bg-gradient-to-b from-[#c4c2c2] to-light dark:from-[#272626] dark:to-secondary rounded-3xl">
            </div>
        </div>
    );
};
